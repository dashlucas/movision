      ...
      <div className="flex w-full items-center justify-center bg-panel-right p-8 md:w-1/2">
        <div className="flex flex-col items-center gap-6">
          ...
          <Button
            ...
            size="lg"
            variant="outline"
            className="h-[60px] w-[356px] rounded-2xl border-4 border-primary bg-background text-2xl font-bold text-panel-right shadow-lg transition-transform hover:scale-105 hover:bg-primary/10 focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background"
          >
