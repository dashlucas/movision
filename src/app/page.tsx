...
export default function Home() {
  return (
    <main className="flex min-h-screen w-full flex-col bg-panel-right md:flex-row">
      ...
      {/* Right Panel */}
      <div className="flex w-full flex-1 items-center justify-center p-8 md:w-1/2">
        <div className="flex flex-col items-center gap-6">
          ...
          <Button
            ...
            size="lg"
            variant="outline"
            className="h-14 w-72 rounded-2xl border-4 border-primary bg-background text-xl font-bold text-tutorial shadow-lg transition-transform hover:scale-105 hover:bg-primary hover:text-primary-foreground focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background md:h-[60px] md:w-[356px] md:text-2xl"
          >
